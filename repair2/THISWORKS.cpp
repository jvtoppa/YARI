...
//2: relink pairs and fix data structures:
    ...
    vector<PAIRNODE*>& q)
{
    ...
    while (true)
    {
        ...
        CFG.push_back(mostFreqPair->left);
        CFG.push_back(mostFreqPair->right);
        ...
        if(iterator % static_cast<int>(ceil(s.size() / 4)) == 0)
        {
            iterator = 0;
            compactify(ht, s, q);
        }
...
int main()
{
    string input = "singing do wah diddy diddy dum diddy do singing do wah diddy diddy dum diddy do singing do wah diddy diddy dum diddy do singing do wah diddy diddy dum diddy do";
    //string input = "abababab";
   // string input = "ABCABABABCCDABCD";
...
//    printDS(ht, s, q);
    ...
    cout << "\n";
    cout << "Size of input string: " << s.size() << "\n";
    freeAll(ht, q);
    return 0;
}
